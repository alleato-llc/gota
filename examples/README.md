...
A complete, runnable Gota consumer in miniature: nine runners (Rust, C, Go, Zig, Java,
Swift, Haskell, Python, TypeScript), one per language template, each plugged into its language's
